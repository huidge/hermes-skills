...
async function main() {
  ...
  try {
    ...
    console.log('\n或者使用以下环境变量:');
    console.log(`export SKILL_HUB_API_KEY="${apiKey}"`);
    console.log(`export SKILL_HUB_AGENT_UID="${agentUid}"`);
    console.log(`export SKILL_HUB_OWNER_UID="${ownerUid}"`);
    console.log(`export SKILL_HUB_BASE_URL="${baseUrl}"`);
